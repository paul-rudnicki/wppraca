...
function yourprefix_register_demo_metabox() {
	...
	$cmb_demo = new_cmb2_box( array(
		'id'            => $prefix . 'metabox',
		'title'         => esc_html__( 'Ustawienia Pracy', 'cmb2' ),
	...
	$cmb_demo->add_field( array(
		'name'             => esc_html__( 'Rodzaj', 'cmb2' ),
		'id'               => $prefix . 'type',
		'type'             => 'select',
		'show_option_none' => true,
		'options'          => array(
			'Etat' => esc_html__( 'Etat', 'cmb2' ),
			'Zlecenie'   => esc_html__( 'Zlecenie', 'cmb2' )
		),
	) );

	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Lokalizacja', 'cmb2' ),
		'id'   => $prefix . 'location',
		'type' => 'text',
	) );

	$cmb_demo->add_field( array(
		'name'             => esc_html__( 'Wyróżnione', 'cmb2' ),
		'id'               => $prefix . 'featured',
		'type'             => 'select',
		'show_option_none' => true,
		'options'          => array(
			'featured' => esc_html__( 'Wyróżnione', 'cmb2' )
		),
	) );

	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Token', 'cmb2' ),
		'id'   => $prefix . 'remove_token',
		'type' => 'text',
	) );
